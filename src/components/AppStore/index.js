...
const appsList = [
  {
    appId: -1,
    appName: 'Multi Lingual Chat',
    imageUrl:
      'https://res.cloudinary.com/jayakrishnavamsi/image/upload/v1709276973/icon_zn6ghm.png',
    category: 'SOCIAL',
  },
  {
    appId: 0,
  ...
  render() {
    ...
    return (
      <div className="bg-container">
        <h1 className="title"> Cross Platform App Store </h1>
